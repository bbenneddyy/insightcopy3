    ...
    <>
      ...
      <div className="bg-white">
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pt-14 -z-10">
          <div className="mx-auto max-w-3xl py-12 sm:py-12 lg:py-12">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link
                  href="/register"
                  className={webStatus === "open" ? "rounded-md bg-green-600 px-6 py-2.5 text-xl font-semibold text-white shadow-xs hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600" : "rounded-md bg-slate-200 px-6 py-2.5 text-xl text-gray-300 font-semibold pointer-events-none"}
                >
          ...
          >
            <div
              className="relative left-[calc(50%+3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 bg-linear-to-tr from-[#16a34a] to-[#22c55e]  opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
              style={{
                clipPath:
