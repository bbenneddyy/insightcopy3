...
export async function createParticipant(
  ...
  try {
    ...
    sendMail({
      ...
      firstname: data.firstname,
      lastname: data.lastname,
      text: "ทางนิสิตผู้จัดงานขอขอบคุณที่ท่านได้สมัครเข้าร่วมงานเสวนาเปิดรั้วหมอจุฬาฯ ครั้งที่ 34 ประจำปีการศึกษา 2567 โดยทางทีมงาน ขอความร่วมมือกรุณารออีเมลยืนยันการตรวจสอบหลักฐานการชำระเงิน และจะส่งอีเมลยืนยันไปให้ท่านอีกครั้งหนึ่ง",
    });
