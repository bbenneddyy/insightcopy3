    ...
    if (status === "accepted") {
      if (user.site === "online") {
        mailOptions.text = `ทางผู้จัดงานขอยืนยันการเข้าร่วมงานเสวนาของท่าน โดยขอแจ้งรายละเอียดงาน ดังนี้
          ...
          จากอาจารย์และรุ่นพี่คณะแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย” ในวันที่ 1
          พฤศจิกายน 2568 เวลา 09.00 น. ถึง 15.25 น.ในรูปแบบ Online ผ่านระบบ zoom โดยสำหรับ
          URL สำหรับเข้าร่วมจะส่งให้ภายใน 7 วันก่อนเริ่มงาน หรือสามารถเข้าร่วมงานผ่านระบบ login ทาง insight.docchula.com`;
      } else if (user.site === "onsite") {
        mailOptions.text = `ทางผู้จัดงานขอยืนยันการเข้าร่วมงานเสวนาของท่านโดยขอแจ้งรายละเอียดงาน ดังนี้
          “งานเสวนาเปิดรั้วหมอจุฬาฯ ครั้งที่ ${eventNumber} งานที่คลายข้อสงสัย เจาะลึกประสบการณ์ในการเรียนแพทย์
          จากอาจารย์และรุ่นพี่คณะแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย” ในวันที่ 1
          พฤศจิกายน 2568 ในรูปแบบ Onsite ณ เวลา 09.00 น. ถึง 15.25 น.
